  ...
  render() {
    return (
      <Modal
        ...
        <h3>Disclaimer</h3><span className="avatar-box"><img src="https://maplestory.io/api/kms/328/character/center/2000/1073181,1053109,1053109,1004862,33005,21544/sit/0"/></span>
